...
} = require('./path_to_your_module'); // replace with your actual module path
...
describe('Document Processing Functions', () => {
  ...
  beforeEach(() => {
    ...
    const parserStub = sinon.createStubInstance(xml2js.Parser);
    parseStringPromiseStub = parserStub.parseStringPromise;
    ...
    sinon.stub(xml2js, 'Parser').returns(parserStub);
  });
